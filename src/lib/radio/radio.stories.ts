...
import { AptoRadioButtonComponentModule } from './radio.module';
...
storiesOf('Radio', module)
    .addDecorator(
        moduleMetadata({
            imports: [ AptoRadioButtonComponentModule ]
        })
    )
    ...
    .add('Radio Group', withMarkdownNotes(paragraphMd)(() => ({
        template: `
            ...
            <apto-radio-group (change)="groupChanged($event)">
                <apto-radio-button block name="day" value="monday">Monday</apto-radio-button>
                <apto-radio-button block name="day" checked value="tuesday">Tuesday</apto-radio-button>
                <apto-radio-button block name="day" value="wednesday">Wednesday</apto-radio-button>
            </apto-radio-group>


            <h3>Disabled Radio Group with block radio buttons</h3>
            <apto-radio-group disabled (change)="groupChanged($event)">
                <apto-radio-button block name="day" value="monday">Monday</apto-radio-button>
                <apto-radio-button block name="day" value="tuesday">Tuesday</apto-radio-button>
                <apto-radio-button block name="day" value="wednesday">Wednesday</apto-radio-button>
            </apto-radio-group>
